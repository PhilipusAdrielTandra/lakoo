  ...
  return (
    <div className='h-screen mx-auto flex justify-center items-center bg-white flex-col text-lakoo-red'>
      <div className="flex items-center">
        <h1 className='font-hk text-9xl'>lakoo</h1>
        <p className='font-hk text-xl ml-4'>JOIN THE MOVEMENT <br/><a className='underline' href="https://chat.whatsapp.com/DcaQ1bjLOkY3kz2GrYgPVs">CLICK ME</a></p>
      </div>
